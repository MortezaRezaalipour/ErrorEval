...
g137=Not(g135)
g138=Not(app_g136)
g139=And(g119,app_g136)
g140=And(g122,app_g136)
g141=Not(app_g136)
g142=And(g134,g137)
g143=And(g121,g138)
g144=Not(g139)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/sad_i10_o3_single_gate_removal_monotonic/sad_i10_o3_single_gate_removal_monotonic_g136.csv', 'w') as f:
