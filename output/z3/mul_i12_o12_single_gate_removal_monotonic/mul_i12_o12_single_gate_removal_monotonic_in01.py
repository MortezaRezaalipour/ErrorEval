...
g22=And(in07,in02)
g23=And(in06,in02)
g24=And(in11,app_in01)
g25=And(in10,app_in01)
g26=And(in09,app_in01)
g27=And(in08,app_in01)
g28=And(in07,app_in01)
g29=And(in06,app_in01)
g30=And(in11,in00)
g31=And(in10,in00)
g32=And(in09,in00)
g33=And(in08,in00)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/mul_i12_o12_single_gate_removal_monotonic/mul_i12_o12_single_gate_removal_monotonic_in01.csv', 'w') as f:
