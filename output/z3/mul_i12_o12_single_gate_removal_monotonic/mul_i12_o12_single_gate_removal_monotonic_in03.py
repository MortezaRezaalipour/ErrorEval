...
g10=And(in07,in04)
g11=And(in06,in04)
g12=And(in11,app_in03)
g13=And(in10,app_in03)
g14=And(in09,app_in03)
g15=And(in08,app_in03)
g16=And(in07,app_in03)
g17=And(in06,app_in03)
g18=And(in11,in02)
g19=And(in10,in02)
g20=And(in09,in02)
g21=And(in08,in02)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/mul_i12_o12_single_gate_removal_monotonic/mul_i12_o12_single_gate_removal_monotonic_in03.csv', 'w') as f:
