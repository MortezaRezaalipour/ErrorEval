...
g28=And(in07,in01)
g29=And(in06,in01)
g30=And(in11,app_in00)
g31=And(in10,app_in00)
g32=And(in09,app_in00)
g33=And(in08,app_in00)
g34=And(in07,app_in00)
g35=And(in06,app_in00)
g36=Not(g1)
g37=Not(g2)
g38=Not(g4)
g39=Not(g5)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/mul_i12_o12_single_gate_removal_monotonic/mul_i12_o12_single_gate_removal_monotonic_in00.csv', 'w') as f:
