...
g0=And(in11,in05)
g1=And(app_in10,in05)
g2=And(in09,in05)
g3=And(in08,in05)
g4=And(in07,in05)
g5=And(in06,in05)
g6=And(in11,in04)
g7=And(app_in10,in04)
g8=And(in09,in04)
g9=And(in08,in04)
g10=And(in07,in04)
g11=And(in06,in04)
g12=And(in11,in03)
g13=And(app_in10,in03)
g14=And(in09,in03)
g15=And(in08,in03)
g16=And(in07,in03)
g17=And(in06,in03)
g18=And(in11,in02)
g19=And(app_in10,in02)
g20=And(in09,in02)
g21=And(in08,in02)
g22=And(in07,in02)
g23=And(in06,in02)
g24=And(in11,in01)
g25=And(app_in10,in01)
g26=And(in09,in01)
g27=And(in08,in01)
g28=And(in07,in01)
g29=And(in06,in01)
g30=And(in11,in00)
g31=And(app_in10,in00)
g32=And(in09,in00)
g33=And(in08,in00)
g34=And(in07,in00)
g35=And(in06,in00)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/mul_i12_o12_single_gate_removal_monotonic/mul_i12_o12_single_gate_removal_monotonic_in10.csv', 'w') as f:
