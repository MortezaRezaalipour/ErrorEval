...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/sad_i10_o3_single_gate_removal_monotonic/sad_i10_o3_single_gate_removal_monotonic_in04.csv', 'w') as f:
