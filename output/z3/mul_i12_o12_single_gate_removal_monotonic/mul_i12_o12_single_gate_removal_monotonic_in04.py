...
g4=And(in07,in05)
g5=And(in06,in05)
g6=And(in11,app_in04)
g7=And(in10,app_in04)
g8=And(in09,app_in04)
g9=And(in08,app_in04)
g10=And(in07,app_in04)
g11=And(in06,app_in04)
g12=And(in11,in03)
g13=And(in10,in03)
g14=And(in09,in03)
g15=And(in08,in03)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/mul_i12_o12_single_gate_removal_monotonic/mul_i12_o12_single_gate_removal_monotonic_in04.csv', 'w') as f:
