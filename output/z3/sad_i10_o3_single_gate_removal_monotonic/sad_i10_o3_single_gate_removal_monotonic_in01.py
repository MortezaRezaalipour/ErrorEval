...
g57=And(g24,g44)
g58=And(g22,g45)
g59=And(app_in01,g46)
g60=And(g36,g47)
g61=And(app_in01,g48)
g62=And(g38,g49)
g63=Not(g50)
g64=Not(g51)
g65=Not(g52)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/sad_i10_o3_single_gate_removal_monotonic/sad_i10_o3_single_gate_removal_monotonic_in01.csv', 'w') as f:
