...
g16=And(in07,in03)
g17=And(in06,in03)
g18=And(in11,app_in02)
g19=And(in10,app_in02)
g20=And(in09,app_in02)
g21=And(in08,app_in02)
g22=And(in07,app_in02)
g23=And(in06,app_in02)
g24=And(in11,in01)
g25=And(in10,in01)
g26=And(in09,in01)
g27=And(in08,in01)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/mul_i12_o12_single_gate_removal_monotonic/mul_i12_o12_single_gate_removal_monotonic_in02.csv', 'w') as f:
