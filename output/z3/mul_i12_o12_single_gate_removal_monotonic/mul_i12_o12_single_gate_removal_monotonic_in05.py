...
g0=And(in11,app_in05)
g1=And(in10,app_in05)
g2=And(in09,app_in05)
g3=And(in08,app_in05)
g4=And(in07,app_in05)
g5=And(in06,app_in05)
g6=And(in11,in04)
g7=And(in10,in04)
g8=And(in09,in04)
g9=And(in08,in04)
...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/mul_i12_o12_single_gate_removal_monotonic/mul_i12_o12_single_gate_removal_monotonic_in05.csv', 'w') as f:
