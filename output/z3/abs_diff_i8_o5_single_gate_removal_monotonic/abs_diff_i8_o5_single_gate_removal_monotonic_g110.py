...
while(not foundWCE):
	...
	if response == unsat:
		...
		stats['wce'] = stats['et']
end_whole = time.time()
with open('output/report/abs_diff_i8_o5_single_gate_removal_monotonic/abs_diff_i8_o5_single_gate_removal_monotonic_g110.csv', 'w') as f:
